...
type OauthInitParameters struct {
	...
	// References to SourceOauth in propertymapping to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.Reference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of SourceOauth in propertymapping to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
