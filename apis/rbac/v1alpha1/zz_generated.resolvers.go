...
// ResolveReferences of this RbacInitialPermissions.
func (mg *RbacInitialPermissions) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this RbacPermissionRole.
func (mg *RbacPermissionRole) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this RbacPermissionUser.
func (mg *RbacPermissionUser) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
