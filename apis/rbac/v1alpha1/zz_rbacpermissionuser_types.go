...
type RbacPermissionUserInitParameters struct {
	...
	// (Number)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/directory/v1alpha1.User
...
type RbacPermissionUserObservation struct {
...
type RbacPermissionUserParameters struct {
...
// RbacPermissionUserSpec defines the desired state of RbacPermissionUser
type RbacPermissionUserSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RbacPermissionUserParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RbacPermissionUserInitParameters `json:"initProvider,omitempty"`
}

// RbacPermissionUserStatus defines the observed state of RbacPermissionUser.
type RbacPermissionUserStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RbacPermissionUserObservation `json:"atProvider,omitempty"`
}
...
// RbacPermissionUser is the Schema for the RbacPermissionUsers API.
...
type RbacPermissionUser struct {
	...
	Spec   RbacPermissionUserSpec   `json:"spec"`
	Status RbacPermissionUserStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RbacPermissionUserList contains a list of RbacPermissionUsers
type RbacPermissionUserList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RbacPermissionUser `json:"items"`
}

// Repository type metadata.
var (
	RbacPermissionUser_Kind             = "RbacPermissionUser"
	RbacPermissionUser_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RbacPermissionUser_Kind}.String()
	RbacPermissionUser_KindAPIVersion   = RbacPermissionUser_Kind + "." + CRDGroupVersion.String()
	RbacPermissionUser_GroupVersionKind = CRDGroupVersion.WithKind(RbacPermissionUser_Kind)
)

func init() {
	SchemeBuilder.Register(&RbacPermissionUser{}, &RbacPermissionUserList{})
}
