...
type RbacPermissionRoleInitParameters struct {
...
type RbacPermissionRoleObservation struct {
...
type RbacPermissionRoleParameters struct {
...
// RbacPermissionRoleSpec defines the desired state of RbacPermissionRole
type RbacPermissionRoleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RbacPermissionRoleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RbacPermissionRoleInitParameters `json:"initProvider,omitempty"`
}

// RbacPermissionRoleStatus defines the observed state of RbacPermissionRole.
type RbacPermissionRoleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RbacPermissionRoleObservation `json:"atProvider,omitempty"`
}
...
// RbacPermissionRole is the Schema for the RbacPermissionRoles API.
...
type RbacPermissionRole struct {
	...
	Spec   RbacPermissionRoleSpec   `json:"spec"`
	Status RbacPermissionRoleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RbacPermissionRoleList contains a list of RbacPermissionRoles
type RbacPermissionRoleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RbacPermissionRole `json:"items"`
}

// Repository type metadata.
var (
	RbacPermissionRole_Kind             = "RbacPermissionRole"
	RbacPermissionRole_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RbacPermissionRole_Kind}.String()
	RbacPermissionRole_KindAPIVersion   = RbacPermissionRole_Kind + "." + CRDGroupVersion.String()
	RbacPermissionRole_GroupVersionKind = CRDGroupVersion.WithKind(RbacPermissionRole_Kind)
)

func init() {
	SchemeBuilder.Register(&RbacPermissionRole{}, &RbacPermissionRoleList{})
}
