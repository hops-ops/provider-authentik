...
type RACInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/propertymapping/v1alpha1.ProviderRac
	PropertyMappings []*string `json:"propertyMappings,omitempty" tf:"property_mappings,omitempty"`

	// References to ProviderRac in propertymapping to populate propertyMappings.
	// +kubebuilder:validation:Optional
	PropertyMappingsRefs []v1.Reference `json:"propertyMappingsRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderRac in propertymapping to populate propertyMappings.
	// +kubebuilder:validation:Optional
