...
type SCIMInitParameters struct {
	...
	// (List of String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/propertymapping/v1alpha1.ProviderScim
	...
	// References to ProviderScim in propertymapping to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupRefs []v1.Reference `json:"propertyMappingsGroupRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderScim in propertymapping to populate propertyMappingsGroup.
	// +kubebuilder:validation:Optional
	PropertyMappingsGroupSelector *v1.Selector `json:"propertyMappingsGroupSelector,omitempty" tf:"-"`

	// References to ProviderScim in propertymapping to populate propertyMappings.
	// +kubebuilder:validation:Optional
	PropertyMappingsRefs []v1.Reference `json:"propertyMappingsRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderScim in propertymapping to populate propertyMappings.
	// +kubebuilder:validation:Optional
