...
type OutpostInitParameters struct {
	...
	// (List of Number)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/applications/v1alpha1.ProviderProxy
	ProtocolProviders []*float64 `json:"protocolProviders,omitempty" tf:"protocol_providers,omitempty"`

	// References to ProviderProxy in applications to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersRefs []v1.Reference `json:"protocolProvidersRefs,omitempty" tf:"-"`

	// Selector for a list of ProviderProxy in applications to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersSelector *v1.Selector `json:"protocolProvidersSelector,omitempty" tf:"-"`

	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/applications/v1alpha1.ServiceConnectionKubernetes
	ServiceConnection *string `json:"serviceConnection,omitempty" tf:"service_connection,omitempty"`

	// Reference to a ServiceConnectionKubernetes in applications to populate serviceConnection.
	// +kubebuilder:validation:Optional
	ServiceConnectionRef *v1.Reference `json:"serviceConnectionRef,omitempty" tf:"-"`

	// Selector for a ServiceConnectionKubernetes in applications to populate serviceConnection.
	// +kubebuilder:validation:Optional
