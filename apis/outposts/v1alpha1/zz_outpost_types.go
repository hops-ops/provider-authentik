...
type OutpostInitParameters struct {
	...
	// (List of Number)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/providers/v1alpha1.Proxy
	ProtocolProviders []*float64 `json:"protocolProviders,omitempty" tf:"protocol_providers,omitempty"`

	// References to Proxy in providers to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersRefs []v1.Reference `json:"protocolProvidersRefs,omitempty" tf:"-"`

	// Selector for a list of Proxy in providers to populate protocolProviders.
	// +kubebuilder:validation:Optional
	ProtocolProvidersSelector *v1.Selector `json:"protocolProvidersSelector,omitempty" tf:"-"`

	// (String)
	// +crossplane:generate:reference:type=github.com/unbounded-tech/provider-authentik/apis/k8s/v1alpha1.ServiceConnection
